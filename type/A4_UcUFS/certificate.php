...
// Adicionando texto de certificaÃ§Ã£o que informa nome completo, data de inÃ­cio e fim do curso e sua carga horaria
$nome_completo = fullname($USER); //Recuperando nome completo do usuario
$data_inicio = date('d/m/Y', $course->startdate); //Recuperando data de inÃ­cio cadastrado nas configuraÃ§Ãµes do curso 
...
// Adicionando quadro com cÃ³digo de autenticaÃ§Ã£o, dia e horÃ¡rio de autenticaÃ§Ã£o.
