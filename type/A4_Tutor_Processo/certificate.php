...
$texto_certificacao = "Certificamos que o(a) Sr(a) $nome_completo exerceu atividade de Tutor de Processo do curso $course->fullname, promovido pela Divisão de Desenvolvimento de Pessoal - DIDEP/DDRH/PROGEP, no período de $data_inicio a $data_final, com carga horária total de $carga_horaria horas.";
