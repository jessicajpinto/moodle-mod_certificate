 ...
 * Recupera os tópicos para formar a lista de módulos cursados pelo estudante e formar o conteúdo programático. Basea-se
 ...
 * Cria retângulo onde ficará a assinatura do chefe do setor e código de autenticação.
 *
 * @param stdClass $pdf
 * @param stdClass $certificate
 */
function certificate_criarRetanguloAutenticacao($pdf, $certificate) {
	...
	switch ($certificate->orientation) {
		case 'L':
			// criar linha de borda na cor especificada na vari�vel $color
